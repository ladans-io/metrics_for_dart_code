...
abstract class HtmlReporter<T extends FileReport, P> extends Reporter<T, P> {
  ...
  Future<void> copyResources() async {
    const resources = [
      'package:metrics_for_dart_code/src/reporters/resources/variables.css',
      'package:metrics_for_dart_code/src/reporters/resources/normalize.css',
      'package:metrics_for_dart_code/src/reporters/resources/base.css',
      'package:metrics_for_dart_code/src/reporters/resources/main.css',
    ];
